...
Ansible Role for Centro Criptológico Nacional (CCN) - STIC for Red Hat Enterprise Linux 9 - Intermediate  
...
Run `ansible-galaxy install RedHatOfficial.rhel9_ccn_intermediate` to
download and install the role. Then, you can use the following playbook snippet to run the Ansible role:

    - hosts: all
      roles:
         - { role: RedHatOfficial.rhel9_ccn_intermediate }
